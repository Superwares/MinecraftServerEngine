...
public class RegionFile {
    ...
    public DataOutputStream b(int var1, int var2) {
        return this.d(var1, var2) ? null : new DataOutputStream(new BufferedOutputStream(new DeflaterOutputStream(new ChunkBuffer(var1, var2))));
    }
    ...
    private synchronized int getOffset(int var1, int var2) {
