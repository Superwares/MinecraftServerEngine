...
namespace TestMinecraftServerApplication
{
    ...
    public sealed class CountdownNode : IGameProgressNode
    {
        ...
        public readonly TextComponent[] Message = [
            ...
            new TextComponent($"술래승리 +포인트:    {GameContext.RoundSeekerWinAdditionalPoints}\n", TextColor.Gray),
            new TextComponent($"생존승리 +포인트:    {GameContext.RoundHiderWinAdditionalPoints}\n", TextColor.Gray),
            new TextComponent($"킬      +코인:      {GameContext.KillCoins}\n",  TextColor.Gray),
            new TextComponent($"생존    +코인:      {GameContext.RoundSurvivingCoins}\n",  TextColor.Gray),
            new TextComponent($"술래승리 +코인:      {GameContext.RoundSeekerWinCoins}\n", TextColor.Gray),
            new TextComponent($"생존승리 +코인:      {GameContext.RoundHiderWinCoins}\n", TextColor.Gray),
            new TextComponent($"\n", TextColor.White),
